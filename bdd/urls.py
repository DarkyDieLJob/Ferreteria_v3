...
try:
    ...
    for nav_bar in NavBar.objects.all():
        try:
            ...
            armador_paths.append(
                path(nav_bar.url_inicial, vista.as_view(), name=nav_bar.text_display)
            )
            # print(armador)
            # print(vista)
            # print(armador_paths)
...
urlpatterns += [
    ...
    path(
        "agregar_articulo_a_carrito/<int:id_articulo>/",
        agregar_articulo_a_carrito,
        name="agregar_articulo_a_carrito",
    ),
    path(
        "cambiar_cantidad_pedido/<int:id_articulo>/<int:cantidad>/",
        cambiar_cantidad_pedido,
        name="cambiar_cantidad_pedido",
    ),
    path(
        "crear_modificar_lista_pedidos/",
        crear_modificar_lista_pedidos,
    ...
    path(
        "eliminar_articulo_pedido/",
        eliminar_articulo_pedido,
        name="eliminar_articulo_pedido",
    ),
    path(
        "crear_modificar_lista_pedidos/<int:proveedor_id>",
        crear_modificar_lista_pedidos,
        name="mi_vista_ajax_get",
    ),
    ...
    path(
        "agregar_articulo_a_pedido/<int:articulo_id>/",
        agregar_al_pedido,
