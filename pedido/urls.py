...
urlpatterns = [
    ...
    path("nuevo_pedido/<int:proveedor_id>", nuevo_pedido, name="nuevo-pedido"),
    # Buscar articulos
    ...
    path(
        "controlar_pedido/<int:pedido_id>",
        ControlarPedidoView.as_view(),
        name="controlar-pedido",
    ),
    path("agregar_devolucion/", agregar_devolucion, name="agregar-devolucion"),
    path(
        "actualizar_llego/<int:articulo_id>", actualizar_llego, name="actualizar-llego"
    ),
