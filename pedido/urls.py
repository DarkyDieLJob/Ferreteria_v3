...
urlpatterns = [
    ...
    path('listar_devoluciones/', ListarDevolucionesView.as_view(), name='listar-devoluciones'),
    path('eliminar_devolucion/', ListarDevolucionesView.as_view(), name='eliminar-devolucion'),
