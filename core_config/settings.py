...
# Seguridad #################
###########
# Lee el nombre de la variable de entorno desde un archivo
with io.open('SECRET_KEY.txt', 'r', encoding='utf-8') as f:
...
ALLOWED_HOSTS = ['darkydiel.pythonanywhere.com','localhost','192.168.1.104']
