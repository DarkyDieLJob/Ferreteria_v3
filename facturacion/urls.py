...
from facturacion.views import (
    ...
    obtener_cliente,
    agregar_articulo_sin_registro,
)
from facturacion.views import (
    eliminar_articulo,
    eliminar_articulo_sin_registro,
...
urlpatterns = [
    ...
    path(
        "agregar_articulo_sin_registro/",
        agregar_articulo_sin_registro,
        name="agregar_articulo_sin_registro",
    ),
    path("eliminar_articulo/", eliminar_articulo, name="eliminar_articulo"),
    path(
        "eliminar_articulo_sin_registro/",
        eliminar_articulo_sin_registro,
        name="eliminar_articulo_sin_registro",
    ),
    path(
        "actualizar_cantidad_articulo/",
        actualizar_cantidad_articulo,
        name="actualizar_cantidad_articulo",
    ),
    path(
        "actualizar_cantidad_articulo_sin_registro/",
        actualizar_cantidad_articulo_sin_registro,
    ...
    path(
        "facturacion/<int:year>/<int:month>/<int:day>/",
        Facturacion.as_view(),
        name="facturacion_fecha",
    ),
    path(
        "consulta_impresora_generica/",
        consulta_impresora_fiscal_generica,
        name="consulta_impresora_generica",
    ),
]
