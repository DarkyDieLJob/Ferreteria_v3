"""
Vista para la interfaz de ejemplo de testing.
"""
from django.views.generic import TemplateView
from core_testing.testing_interfaces.base import TestingView
from core_testing.testing_interfaces.example import ExampleTestingInterface


class ExampleInterfaceView(TestingView):
    """
    Vista para la interfaz de ejemplo de testing.
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            'page_title': 'Interfaz de Ejemplo',
            'active_tab': 'example',
